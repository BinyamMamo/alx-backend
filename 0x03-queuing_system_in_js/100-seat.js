 ...
 *
 * @param {number} number - The new number of available seats to set.
 * @returns {Promise<void>} A promise that resolves when the number
 *  of available seats has been updated.
 */
 ...
 *
 * @returns {Promise<string>} A promise that resolves to the current
 *  number of available seats as a string.
 */
